      ...
      <div className="max-w-6xl mx-auto px-6 sm:px-6 lg:px-8">
        ...
        <div className="pt-8 border-t border-accent/50">
          <div className="flex flex-wrap justify-center gap-x-8 gap-y-4 mb-8">
            <a href="mailto:saividesh29@gmail.com" className="flex items-center gap-2 text-muted-foreground hover:text-primary transition-colors">
              <Mail className="w-4 h-4" />
              <span className="text-sm">saividesh29@gmail.com</span>
            </a>
            <a href="tel:+917396733009" className="flex items-center gap-2 text-muted-foreground hover:text-primary transition-colors">
              <Phone className="w-4 h-4" />
              <span className="text-sm">+91 73967 33009</span>
            </a>
            <a href="https://wa.me/917396733009?text=Hi%20Sai" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-muted-foreground hover:text-primary transition-colors">

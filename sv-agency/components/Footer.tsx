...
import { Sparkles, Globe, Mail, MessageCircle, Code, Phone } from "lucide-react";
        ...
        <div className="grid md:grid-cols-2 gap-12 mb-12">
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-xl font-bold">SV Agency</span>
            </div>
          ...
          {/* Owner Info */}
          <div>
            <h4 className="font-semibold mb-4">About the Builder</h4>
            <div className="p-4 bg-secondary/20 border border-border">
              <div className="flex items-center gap-3 mb-3">
                ...
                <div>
                  <div className="font-semibold">Sai Videsh</div>
